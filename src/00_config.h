// RT-003 v5.0 firmware configuration.
...
const char* BUILD_VERSION = "5.0-016";
...
#define RT003_DEBUG_ADKEY 1  // bench only: set to 0 after HU-055 button thresholds are calibrated
